...
@section('content')
    ...
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">@yield('action', 'Nhập số tập max')</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('admin.episodes.store') }}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="category">Nhập số tập cao nhất bạn muốn</label>
                    <input type="number" class="form-control" id="category" name="episodes_number"

...
@section('content')
    ...
    <div class="card card-success">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('admin.categories.storeCategories') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label for="categories">Thêm thể loại phim</label>
                    <input type="text" class="form-control" id="categories" name="name"

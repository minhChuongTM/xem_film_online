                            ...
                            <div class="tab-content p-0">
                                ...
                                <div class="chart tab-pane active" id="revenue-chart"
                                    ...
                                    <canvas id="revenue-chart-canvas" height="300"
                                        style="height: 300px; display: block; width: 643px;" width="643"
                    ...
                    <div class="card bg-gradient-primary">
                        ...
                        <div class="card-body">
                            <div id="world-map"
                                ...
                                <svg width="443.328" height="250">
                                    <g transform="scale(0.42158516020236086) translate(46.28700800000001, 0)">
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                            original="#f4f3f0" id="jqvmap1_fl" class="jqvmap-region" fill-opacity="1">
                                        </path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                            original="#f4f3f0" id="jqvmap1_tx" class="jqvmap-region" fill-opacity="1">
                                        </path>
                                        <path
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="picker-switch" data-action="pickerSwitch"
                                                                    colspan="5" title="Select Month">November 2022
                                                                </th>
